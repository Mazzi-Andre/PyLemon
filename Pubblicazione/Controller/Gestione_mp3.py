...
class Gestione_mp3():
    ...
    def Carica_mp3(self, percorsofile):
        ...
        if os.path.isfile(percorsofile):
            shutil.copy(percorsofile, 'Gestione_Ascolto/Contenuti/View/Data/mp3')
            ...
            id  = id+1
            newfile = str(id) + ".mp3"
            shutil.move('Gestione_Ascolto/Contenuti/View/Data/mp3/' + nomefile, 'Gestione_Ascolto/Contenuti/View/Data/mp3/' + newfile)
            #sium= 'Gestione_Ascolto/Contenuti/View/Data/mp3/' + nomefile
            #shutil.rmtree(sium)
